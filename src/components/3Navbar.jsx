          ...
          <div id="collapseMenu"
            ...
            <ul
              ...
              <li
                ...
                <a href='javascript:void(0)' class='text-black block text-[15px]'>All Notices</a>
              </li>
              <li
                ...
                <a href='javascript:void(0)' class='text-black block text-[15px]'>Academic Notice</a>
              </li>
              <li
                class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-black lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-7 lg:after:transition-all lg:after:duration-300'>
                <a href='javascript:void(0)' class='text-black block text-[15px]'>Administrative Notice</a>
              </li>
              <li
                class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-black lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-7 lg:after:transition-all lg:after:duration-300'>
                <a href='javascript:void(0)' class='text-black block text-[15px]'>University</a>
              </li>
              <li
                class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-black lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-7 lg:after:transition-all lg:after:duration-300'>
                <a href='javascript:void(0)' class='text-black block text-[15px]'>Events</a>
              </li>
              <li
                class='max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:hover:after:absolute lg:after:bg-black lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:top-7 lg:after:transition-all lg:after:duration-300'>
                <a href='javascript:void(0)' class='text-black block text-[15px]'>Contacts</a>
              </li>
            </ul>
          </div>
              ...
              <li id="profile-dropdown-toggle"
                ...
                <div id="profile-dropdown-menu"
                  ...
                  <div className="flex justify-items-start items-center">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Administrative Login Only</p>
                  </div>
